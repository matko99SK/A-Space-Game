...
# load menu content
for i in range(1):
    MenuButton(parent=load_menu, text=f'Start New Game', y=-i * button_spacing, on_click=start_game)
...
background = Entity(parent=menu_parent, model='quad', texture='assets/sky/texture/sky', scale=(camera.aspect_ratio,1), color=color.white, z=1, world_y=0)
#Audio
media_player = vlc.MediaPlayer()
music = vlc.MediaPlayer('UrsinaEngine/assets/audio/mainmenu/mainmenu.flac')
music.play()
for i in range(100):
